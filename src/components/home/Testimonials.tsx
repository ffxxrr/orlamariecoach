    ...
    <section className="py-16 lg:py-24 bg-white relative">
      ...
      <div className="absolute top-[15%] right-[8%] w-12 h-12 opacity-20">
        <div
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><path d='M30 20 Q50 10 70 20 Q80 40 70 60 Q50 70 30 60 Q20 40 30 20' fill='%23C9A475' opacity='0.1'/><circle cx='45' cy='35' r='3' fill='%236E5A2F' opacity='0.2'/><circle cx='55' cy='45' r='2' fill='%23F1CBB8' opacity='0.2'/></svg>")`
          }}
        />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <ScrollReveal key={index} animation="fadeInUp" delay={index * 150}>
              <div
                className="group bg-gradient-to-br from-pure-light via-light-border/30 to-pure-light p-8 rounded-xl border-l-4 border-living-green hover:shadow-md hover:-translate-y-1 transition-all duration-300 relative h-full"
              >
                {/* Decorative Element - Earthy palette */}
                <div className="absolute top-4 right-4 w-5 h-5 opacity-40">
                  <div
                    ...
                    style={{
                      backgroundImage: `url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><circle cx='50' cy='30' r='5' fill='%23C9A475' opacity='0.4'/><circle cx='30' cy='50' r='4' fill='%236E5A2F' opacity='0.4'/><circle cx='70' cy='50' r='4' fill='%23F1CBB8' opacity='0.4'/><circle cx='50' cy='70' r='5' fill='%23C9A475' opacity='0.4'/></svg>")`
                    }}
                  />
                </div>
